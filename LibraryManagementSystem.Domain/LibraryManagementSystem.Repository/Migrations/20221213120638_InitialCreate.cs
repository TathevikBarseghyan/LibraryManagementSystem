        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false, defaultValue: "Author")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookGenre = table.Column<int>(type: "int", maxLength: 20, nullable: false),
                    FixedPrice = table.Column<decimal>(type: "decimal(18,2)", maxLength: 20, nullable: false),
                    DailyPrice = table.Column<decimal>(type: "decimal(18,2)", maxLength: 20, nullable: false),
                    WeeklyPrice = table.Column<decimal>(type: "decimal(18,2)", maxLength: 20, nullable: false),
                    MonthlyPrice = table.Column<decimal>(type: "decimal(18,2)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
